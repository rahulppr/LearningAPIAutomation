...
//        String response_name = "Rahul";
//        assertThat(response_name).isNotNull().isNotBlank().isEqualTo("Rahul");

//        List<String> names = Arrays.asList("John", "Jane", "Doe");
//        assertThat(names).hasSize(3).contains("John").doesNotContain("Singh");
...
//        File file = new File("C:\\Users\\rahul\\IdeaProjects\\AutomationRAATB4x\\Test");
